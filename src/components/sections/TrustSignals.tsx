    ...
    <section className="py-16 bg-gradient-to-r from-gray-50 to-accent-tint">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          ...
          <div className="bg-white rounded-3xl p-6 shadow-lg hover:shadow-xl transition-all">
            <div className="flex items-center justify-between mb-3">
              <div className="w-12 h-12 bg-accent-tint rounded-full flex items-center justify-center">
                <svg className="w-6 h-6 text-accent-ink" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z"/>
                </svg>
              </div>
              <span className="w-3 h-3 bg-accent-tint0 rounded-full animate-pulse"></span>
            </div>
          ...
          {/* Response Time */}
          <div className="bg-white rounded-3xl p-6 shadow-lg hover:shadow-xl transition-all">
            <div className="w-12 h-12 bg-accent-tint rounded-full flex items-center justify-center mb-3">
              <svg className="w-6 h-6 text-accent-ink" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="bg-white rounded-3xl p-6 shadow-lg hover:shadow-xl transition-all">
            ...
            <div className="text-sm text-gray-600">Ücretsiz Ekspertiz</div>
          </div>
        </div>

        {/* Social Proof Banner */}
        <div className="bg-gradient-to-r from-[#2A3136] to-[#131A1E] rounded-[2rem] p-6 text-white shadow-glass">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <div className="text-accent-tint text-sm">
        ...
        <div className="mt-8 flex flex-wrap justify-center items-center gap-6">
          <div className="flex items-center gap-2 text-gray-600">
            <svg className="w-5 h-5 text-accent-ink" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="flex items-center gap-2 text-gray-600">
            ...
            <span className="text-sm font-medium">Noterde Güvenli Devir</span>
          </div>
        </div>
      </div>
    </section>
...
function RecentActivity({ 
  ...
  return (
    <div className="p-4 hover:bg-white/60 transition-colors">
      <div className="flex items-center justify-between">
        ...
        <div className="text-right">
          <div className="font-bold text-accent-ink text-sm">{amount}</div>
