...
export default function CustomerCarePopup() {
  ...
  return (
    <>
      ...
      >
        <div className="rounded-3xl shadow-2xl overflow-hidden relative border border-white/70 bg-[radial-gradient(circle_at_top_left,rgba(56,189,248,0.18),transparent_45%),radial-gradient(circle_at_top_right,rgba(255,94,58,0.2),transparent_42%),linear-gradient(180deg,rgba(255,255,255,0.94),rgba(255,255,255,0.82))] backdrop-blur-2xl">
          {/* Close Button */}
          <button
            onClick={handleClose}
          ...
          <div className="px-6 pt-5">
            <div className="text-center mb-4 rounded-2xl border border-white/70 bg-white/62 px-4 py-4 shadow-glass-sm backdrop-blur-xl">
            ...
            {/* Benefits - Compact */}
            <div className="space-y-2 mb-4 bg-white/72 rounded-2xl p-3 border border-white/80 shadow-glass-sm backdrop-blur-xl">
              <div className="flex items-center gap-2.5">
                <div className="w-7 h-7 bg-accent-tint rounded-full flex items-center justify-center flex-shrink-0">
                  <svg className="w-3.5 h-3.5 text-accent-ink" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="space-y-2.5 mb-4">
              <a
                ...
                className="w-full bg-green-500 bg-gradient-to-r from-green-500 to-green-600 text-white hover:text-white px-5 py-3 rounded-full font-bold hover:from-green-600 hover:to-green-700 transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-2.5 group text-sm md:text-base"
              >
              ...
              <a
                ...
                className="w-full bg-orange-500 bg-gradient-to-r from-orange-500 to-orange-600 text-white hover:text-white px-5 py-3 rounded-full font-bold hover:from-orange-600 hover:to-orange-700 transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-2.5 group text-sm md:text-base"
              >
                <svg className="w-5 h-5 group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="text-center pb-4">
              <p className="text-xs text-gray-500">
                <svg className="w-3.5 h-3.5 inline mr-1 text-accent-ink" fill="currentColor" viewBox="0 0 20 20">
